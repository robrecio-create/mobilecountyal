...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on MobileCountyAL.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'MobileCountyAL.com <noreply@contact.mobilecountyal.com>',
          to: ['hello@mobilecountyal.com'],
          subject: `New Claim Request: ${business.title} — MobileCountyAL.com`,
          reply_to: email,
          text: emailBody,
        }),
